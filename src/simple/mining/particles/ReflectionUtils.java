...
public class ReflectionUtils {
    ...
    public static enum PackageType {
        MINECRAFT_SERVER("MINECRAFT_SERVER", 0, "MINECRAFT_SERVER", 0, "MINECRAFT_SERVER", 0, "net.minecraft.server." + PackageType.getServerVersion()),
        CRAFTBUKKIT("CRAFTBUKKIT", 1, "CRAFTBUKKIT", 1, "CRAFTBUKKIT", 1, "org.bukkit.craftbukkit." + PackageType.getServerVersion()),
        CRAFTBUKKIT_BLOCK("CRAFTBUKKIT_BLOCK", 2, "CRAFTBUKKIT_BLOCK", 2, "CRAFTBUKKIT_BLOCK", 2, CRAFTBUKKIT, "block"),
        CRAFTBUKKIT_CHUNKIO("CRAFTBUKKIT_CHUNKIO", 3, "CRAFTBUKKIT_CHUNKIO", 3, "CRAFTBUKKIT_CHUNKIO", 3, CRAFTBUKKIT, "chunkio"),
        CRAFTBUKKIT_COMMAND("CRAFTBUKKIT_COMMAND", 4, "CRAFTBUKKIT_COMMAND", 4, "CRAFTBUKKIT_COMMAND", 4, CRAFTBUKKIT, "command"),
        CRAFTBUKKIT_CONVERSATIONS("CRAFTBUKKIT_CONVERSATIONS", 5, "CRAFTBUKKIT_CONVERSATIONS", 5, "CRAFTBUKKIT_CONVERSATIONS", 5, CRAFTBUKKIT, "conversations"),
        CRAFTBUKKIT_ENCHANTMENS("CRAFTBUKKIT_ENCHANTMENS", 6, "CRAFTBUKKIT_ENCHANTMENS", 6, "CRAFTBUKKIT_ENCHANTMENS", 6, CRAFTBUKKIT, "enchantments"),
        CRAFTBUKKIT_ENTITY("CRAFTBUKKIT_ENTITY", 7, "CRAFTBUKKIT_ENTITY", 7, "CRAFTBUKKIT_ENTITY", 7, CRAFTBUKKIT, "entity"),
        CRAFTBUKKIT_EVENT("CRAFTBUKKIT_EVENT", 8, "CRAFTBUKKIT_EVENT", 8, "CRAFTBUKKIT_EVENT", 8, CRAFTBUKKIT, "event"),
        CRAFTBUKKIT_GENERATOR("CRAFTBUKKIT_GENERATOR", 9, "CRAFTBUKKIT_GENERATOR", 9, "CRAFTBUKKIT_GENERATOR", 9, CRAFTBUKKIT, "generator"),
        CRAFTBUKKIT_HELP("CRAFTBUKKIT_HELP", 10, "CRAFTBUKKIT_HELP", 10, "CRAFTBUKKIT_HELP", 10, CRAFTBUKKIT, "help"),
        CRAFTBUKKIT_INVENTORY("CRAFTBUKKIT_INVENTORY", 11, "CRAFTBUKKIT_INVENTORY", 11, "CRAFTBUKKIT_INVENTORY", 11, CRAFTBUKKIT, "inventory"),
        CRAFTBUKKIT_MAP("CRAFTBUKKIT_MAP", 12, "CRAFTBUKKIT_MAP", 12, "CRAFTBUKKIT_MAP", 12, CRAFTBUKKIT, "map"),
        CRAFTBUKKIT_METADATA("CRAFTBUKKIT_METADATA", 13, "CRAFTBUKKIT_METADATA", 13, "CRAFTBUKKIT_METADATA", 13, CRAFTBUKKIT, "metadata"),
        CRAFTBUKKIT_POTION("CRAFTBUKKIT_POTION", 14, "CRAFTBUKKIT_POTION", 14, "CRAFTBUKKIT_POTION", 14, CRAFTBUKKIT, "potion"),
        CRAFTBUKKIT_PROJECTILES("CRAFTBUKKIT_PROJECTILES", 15, "CRAFTBUKKIT_PROJECTILES", 15, "CRAFTBUKKIT_PROJECTILES", 15, CRAFTBUKKIT, "projectiles"),
        CRAFTBUKKIT_SCHEDULER("CRAFTBUKKIT_SCHEDULER", 16, "CRAFTBUKKIT_SCHEDULER", 16, "CRAFTBUKKIT_SCHEDULER", 16, CRAFTBUKKIT, "scheduler"),
        CRAFTBUKKIT_SCOREBOARD("CRAFTBUKKIT_SCOREBOARD", 17, "CRAFTBUKKIT_SCOREBOARD", 17, "CRAFTBUKKIT_SCOREBOARD", 17, CRAFTBUKKIT, "scoreboard"),
        CRAFTBUKKIT_UPDATER("CRAFTBUKKIT_UPDATER", 18, "CRAFTBUKKIT_UPDATER", 18, "CRAFTBUKKIT_UPDATER", 18, CRAFTBUKKIT, "updater"),
        CRAFTBUKKIT_UTIL("CRAFTBUKKIT_UTIL", 19, "CRAFTBUKKIT_UTIL", 19, "CRAFTBUKKIT_UTIL", 19, CRAFTBUKKIT, "util");

        private String path;

        private PackageType(String s3, int n3, String s2, int n2, String s, int n4, String path) {
            this.path = path;
        }

        private PackageType(String s3, int n3, String s2, int n2, String s, int n4, PackageType parent, String path) {
            this(s3, n3, s2, n2, s, n4, (Object)((Object)parent) + "." + path);
        }
